            ...
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <ul class="list-inline list-unstyled">
                        <li><span><i class="glyphicon glyphicon-calendar"></i><?php echo $subjects['date']; ?></span>
                        </li>
                    </ul>
                </div>
            </div>
...
<!--                    <h4 class="media-heading">MOET UIT DB KOMEN. TITEL VAN COMMENT</h4>-->
                    ...
                    <ul class="list-inline list-unstyled">
                        <li><span><i class="glyphicon glyphicon-calendar"></i><?php echo $subject['date'];?></span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="form-area">
                ...
                <form method="post" name="post-comment">
                    <div class="form-group">
                        <label><input type="checkbox" id="anonymous" name="anonymous" class="anonymous"> Post comment anonymous</label>
                    </div>
                    <input type="hidden" id="article_id" name="article_id" value="<?php echo $article_id;?>">
                    <div class="form-group">
                        <textarea class="form-control" name="comment" id="message" placeholder="Type your comment here..." maxlength="140" rows="7" required></textarea>
                        <span class="help-block"><p id="characterLeft" class="help-block ">You have reached the limit</p></span>
                    </div>
                    <button type="submit" id="submit" name="submitNewComment" class="btn btn-primary pull-right">Submit Comment</button>
                </form>
            </div>
        </div>
        </div>
